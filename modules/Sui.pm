...
##		'003' => ['x',"Background color: ",'bgcol',"#CCCCCC"],
		...
		'00c' => ['n',"Maximum recent portions to display on recent tab",'reclimit',5,1,20,1,5],

		'015' => ['l',"Import/Export",'ImEx'],
		'016' => ['c',"Use Disambiguation/Filter list",'filterinput'],
		'017' => ['c',"Store tracking site credentials gleaned from imported XML",'gleanfromXML'],
##		'018' => ['s',"Update existing series names/epcounts from imported XML?",'importdiffnames',0,"never","ask","always"],

		'020' => ['l',"Database",'DB'],
		'021' => ['r',"Database type:",'type',0,'M','MySQL','L','SQLite'],
		'022' => ['t',"Server address:",'host'],
		'023' => ['t',"Login name (if required):",'user'],
		'024' => ['c',"Server requires password",'password'],
##		'02a' => ['c',"Update episode record with date on first change of episode"],
##		'029' => ['r',"Conservation priority",'conserve',0,'mem',"Memory",'net',"Network traffic (requires synchronization)"],
##		'025' => ['c',"Maintain extended information table",'exinfo'],
##		'02b' => ['r',"Use ID from:",'idauthority',0,'a',"AnimeDB",'m',"MAL",'h',"Hummingbird",'l',"Local (order of addition)"],
...
##		'033' => ['c',"Put movies on a separate tab",'moviesapart'],
		'034' => ['s',"Notebook tab position: ",'tabson',1,"left","top","right","bottom"],
##		'035' => ['c',"Show suggestions tab",'suggtab'],
		'036' => ['c',"Show recent activity tab",'recenttab'],
		'037' => ['c',"Recent tab active on startup",'activerecent'],
